...
task_to_prompt = {
    "mnli": "Given the following two sentences, please respond in one word if they are an 'entailment', 'neutral', or 'contradiction': "
}
...
def main():
    ...
    # TODO define collator for causal models 
    if model_args.is_causal: 
        data_collator = PrefixCollator(data_collator, prefix=task_to_prompt[data_args.task_name])
